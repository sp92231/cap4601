# Slide Puzzle
# Originated from Al Sweigart al@inventwithpython.com
...
def main():
    ...
    User1Turn=True
    msg = 'User 1 Turn'  # contains the message to show in the upper left corner.
    solved = False
    ...
    while True: # main game loop
        ...
        if solved:
            ...
            if (User1Turn):
                ...
                msg = 'User 2 Turn'  # contains the message to show in the upper left corner.
            drawBoard(mainBoard, msg)
            checkForQuit()
            for event in pygame.event.get(): # event handling loop
                if event.type == MOUSEBUTTONUP:
